  ...
  <div class="wrapper">
    ...
    <article class="article">
      ...
      <p>Martin Selch ist sich sicher: Energietechnisch ist vieles im Umbruch und es verändert sich auch einiges zum Positiven, beispielsweise erzeugt Herrn-ried 150 Prozent mehr Strom, als dort benötigt wird. Dennoch muss deutlich mehr für die
        ...
        zu bauen.</p>
      <blockquote>
        <p>Leider hat die Stadt Parsberg im Oktober 2018 dies vorerst untersagt. Es gibt vielerlei Möglichkeiten, unsere Umwelt vor Kohleabbau und Atomkraftwerken zu schützen, doch sie müssen auch ergriffen werden. Herr Selch ist sich dessen
          bewusst
      ...
      <p>Was genau ist der Solarstammtisch?
        <blockquote>
          <p>Es ist eine Versammlung, zu der man kommen kann, wenn man sich für die Themen Energiewende, erneuerbare Energien, Solar oder Elektroautos interessiert und sich informieren möchte. Durch
            Veranstaltungen und Vorträge ist somit ein reger Informationsaustausch möglich.</p>
        </blockquote>
        <p>Was erhoffen Sie sich für die Zukunft im Punkt der Energiewende?</p>
        <blockquote>
          <p>Ich wünsche mir, dass die Energiewende irgendwann komplett umgesetzt wird und der Schadstoffausstoß immens verringert wird. Denn meine allergrößte Hoffnung ist es,
            das
