...
<body>
  ...
  <div class="wrapper">
    ...
    <article class="article">
      ...
      <p>Martin Selch ist sich sicher:Energietechnisch ist vieles im Umbruch und es verändert sich auch einiges zumPositiven, beispielsweise erzeugt Herrn-ried 150 Prozent mehr Strom, als dort benötigt wird. Dennoch muss deutlichmehr für die
        Energiewende getan wer-den, um von umweltschädigenden En-ergien wegzukommen. Sei es die 10-H Regelung (Windrad muss so weit voneinem Ort weg sein wie die 10-facheHöhe des Windrads) zu beenden oder mehr Photovoltaik-Anlagen auf Freiflä-chen
        zu bauen.</p>
      <p>Leider hat die Stadt Parsberg im Okto-ber 2018 dies vorerst untersagt. Es gibt vielerlei Möglichkeiten, unsereUmwelt vor Kohleabbau und Atomkraft-werken zu schützen, doch sie müssen auch ergriffen werden. Herr Selch istsich dessen bewusst
        und fährt nun schon seit vier Jahren ein Auto mit Elektromo-tor. Er möchte möglichst viele Autofah-rer ermutigen, diesen Schritt ebenfalls zu gehen. Deshalb unterstützt er die Ladeinfrastruktur, indem man bei ihm kostenlos Sonnenstrom laden
        kann.</p>
